...
#         max(all_commits_with_nothing), max(
#             all_commits_with_everything), max(all_commits_with_metrics),
#         min(all_commits_with_nothing), min(
#             all_commits_with_everything), min(all_commits_with_metrics),
#         diff_with_nothing.seconds // 3600, (diff_with_nothing.seconds %
#                                             3600) // 60, diff_with_nothing.seconds % 60,
#         diff_with_everything.seconds // 3600, (diff_with_everything.seconds %
#                                               3600) // 60,
#         diff_with_everything.seconds % 60,
#         diff_with_metrics.seconds // 3600, (diff_with_metrics.seconds %
#                                             3600) // 60, diff_with_metrics.seconds % 60,
